...
This is certainly not an exhaustive list and EVERYONE is encouraged to contribute their ideas either through a pull request, by contributing to the comments in one of the [open issues](https://github.com/sometimesmotion/webliteracytools/issues) (or by creating a new issue) or by participating in the [Ost.io discussion](http://ost.io/@sometimesmotion/webliteracytools). As a caveat- I am still learning how to use Github (and somewhat failing, at that) and this is a work in progress. Therefore, I encourage you to contact me via email with any concerns- twm2(at)humboldt.edu.
...
|Code Combat|[http://codecombat.com/](http://codecombat.com/) [https://github.com/codecombat/codecombat](https://github.com/codecombat/codecombat)|Learn Python, JavaScript and more in a game!|Instruction: game, quest-based Work: it's a game!|
